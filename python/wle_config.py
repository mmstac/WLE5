...
# =========================================================
# DYNAMIC PATH RESOLUTION (CRITICAL FOR .EXE)
# =========================================================
if getattr(sys, 'frozen', False):
    # When running as an .exe, 'sys.executable' points to tools/WLE5_Studio.exe
    TOOLS_DIR = os.path.dirname(sys.executable)
else:
    # When running as a .py file, use the script's location
...
DEFAULT_JOINTS = {
    ...
    # --- Motor Expansion ---
    "motor_speed": {"id": 8, "region": 3, "control_type": 3, "hardware_address": 8, "r_min": 0.0, "r_max": 100.0, "r_init": 0.0, "cmd_min": 0, "cmd_max": 4095, "cmd_init": 0, "def_spd": 255, "max_spd": 255, "max_acc": 255},
    "motor_dir": {"id": 9, "region": 3, "control_type": 4, "hardware_address": 9, "r_min": 0.0, "r_max": 1.0, "r_init": 0.0, "cmd_min": 0, "cmd_max": 1, "cmd_init": 0, "def_spd": 255, "max_spd": 255, "max_acc": 255},
